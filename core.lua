					...
					SpecBisTooltip:CreateMinimapButton(
						{
							...
							["var"] = mmbtn,
							["dbtab"] = SBTTAB,
							["vTT"] = {{"SpecBisTooltip |T136031:16:16:0:0|t", "v|cff3FC7EB0.10.49"}, {"Leftclick", "Open Settings"}, {"Rightclick", "Hide Minimap Icon"}},
							["funcL"] = function()
...
function SpecBisTooltip:InitSettings()
	SBTTAB = SBTTAB or {}
	SpecBisTooltip:SetVersion(AddonName, 136031, "0.10.49")
	sbt_settings = SpecBisTooltip:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("SpecBisTooltip |T136031:16:16:0:0|t v|cff3FC7EB%s", "0.10.49")
		}
	)
